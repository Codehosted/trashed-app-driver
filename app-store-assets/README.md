...
- `artwork/feature-graphic-1024x500.png` — 1024×500 RGB PNG composited from a fresh authenticated landscape Pixel 2 route-map capture.
...
### Apple App Store 6.9-inch screenshots

The three `screenshots/ios-6.9/` files are deterministic 1290×2796 RGB PNGs generated by:

```sh
python3 scripts/generate-ios-app-store-screenshots.py
```

The generator verifies the committed source captures before rendering. It crops only platform chrome or unused canvas, scales the captures, and places them on the store-art background; interface pixels are not redrawn or altered.

- `sources/ios-6.9/driver-route-map.png` — real driver route-map UI from backend `public/marketing/dispatch/driver-app-light-online-phone.png`; SHA-256 `19befefaf2bb8fc2dc5d6b5743ebb802cd5b566a7ddce4f892d180f9d7ec18f4`.
- `sources/ios-6.9/driver-dispatch-chat.png` — authenticated Play reviewer dispatch chat from local capture `build/play-review-capture/02-messages-raw.png`; SHA-256 `c021cd7fb0f2090fdf82b1ce18329d1848429568c6cc57c4d0bf79268a051357`.
- `sources/ios-6.9/driver-route-photos.png` — authenticated Play reviewer route-photo dialog from local capture `build/play-review-capture/04-photos-raw.png`; SHA-256 `b839be8a840a7837ce7207d8e0ca998a807a28519a693a010a79c495c78b9045`.
- `sources/ios-6.9/completed-routes-metrics.png` — real end-of-day saved route telemetry from backend `public/images/product/feature-pages/dispatch-routing-2026-07-28/end-of-day-metrics.png`; SHA-256 `f9b5fab6288ac8d4ad6b335330e473f214c11b8dc79fb75e3b5be06ee2f92097`.

The photo screenshot uses two visibly separate real UI captures: end-of-day saved route telemetry establishes the post-route context, followed by the real route-photo upload dialog. This avoids claiming that the blurred state behind the photo dialog proves route completion.
