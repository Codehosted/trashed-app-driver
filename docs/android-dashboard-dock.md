...
- Existing emulator `emulator-5560` was listed read-only. No installation or device scroll/geometry/navigation runtime claim is made; parent owns emulator UI verification and release. No API/session, iOS, signing or production changes.
